...
public class Bot extends AbilityBot {
    ...
    protected Bot(SmartHomeConfigurationProperties config, StatusService statusService) {
        super(config.getToken(), config.getBotUsername());
        this.responseHandler = new ResponseHandler(this, this.silent, config, statusService);
    }
